        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-left section-heading probootstrap-animate">
              <h1 class="mb0">Modifier un Produit</h1>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-md-12">
              <div class="row probootstrap-gutter0">
                <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                  ...
                  <form action="modifierProduit" method="post" class="probootstrap-form">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" id="idproduit" name="idproduit" value="${ produit.id }">
                    </div>
                    <div class="form-group">
